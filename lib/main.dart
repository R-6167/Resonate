    ...
    try {
      final handler = await AudioService.init(
        ...
        config: const AudioServiceConfig(
          ...
          androidNotificationChannelDescription: 'Playback controls, current song and album artwork for Resonate.',
          notificationColor: Color(0xFF9A7BFF),
      ...
      try {
        await const MethodChannel('com.example.resonate/media_store').invokeMethod<bool>('requestNotificationPermission');
      } catch (_) {}
      if (!mounted) return;
              ...
              child: _startupError == null
                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        const Text('Audio service could not start.', textAlign: TextAlign.center),
                        const SizedBox(height: 8),
                        Text('Resonate startup timed out or failed.\n$_startupError', textAlign: TextAlign.center),
...
class ResonateApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MultiProvider(
        providers: [
          ...
          // The remastered playback core intentionally exposes no native DSP objects yet.
          // EQ/effects are wired back in after the stable transport milestone.
          ChangeNotifierProvider(create: (_) => EqualizerProvider(equalizer: null)),
          ChangeNotifierProvider(create: (context) => AudioEffectsProvider(player: context.read<MusicProvider>().audioPlayer, loudnessEnhancer: null)),
        ...
        child: Consumer<ThemeProvider>(
          builder: (context, themeProvider, _) => MaterialApp(
            ...
            theme: _theme(Brightness.light),
            darkTheme: _theme(Brightness.dark),
            themeMode: themeProvider.useSystemTheme ? ThemeMode.system : (themeProvider.isDarkMode ? ThemeMode.dark : ThemeMode.light),
