...
class _AutopilotTakeoverCardState extends State<AutopilotTakeoverCard> {
  ...
  Future<IntelligenceCompanionProfile> _loadProfile() =>
      IntelligenceCompanionProfile.build(context.read<IntelligenceProvider>());
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Next: ${pendingSong.title}',
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: Theme.of(context).textTheme.titleSmall,
                              ),
                              Text(
                                'I chose this from your listening pattern.',
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                        ...
                        TextButton(
                          onPressed: () => controller.denyPendingTakeover(),
                          child: const Text('Keep current'),
                        ),
                        FilledButton(
                          onPressed: () => controller.allowPendingTakeover(),
                          child: const Text('Let it choose'),
                        ),
                      ],
                    ),
                  ),
