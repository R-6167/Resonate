...
class SettingsScreen extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text('Settings')), body: ListView(padding: const EdgeInsets.only(bottom: 32), children: [
    ...
    _item(context, 'Gapless playback', 'Continuous playback between queued tracks', Icons.all_inclusive, () => _info(context, 'Gapless playback', 'Resonate prepares the next local source in advance where possible so queued tracks can continue without an intentional gap.')),
    ...
    _item(context, 'Resume behaviour', 'Resume after interruption or reopening', Icons.restore_rounded, () => _info(context, 'Resume behaviour', 'Audio interruptions and becoming-noisy events pause playback safely.')),
    _divider(),
    ...
    _item(context, 'Suggestions', 'Recommendations without taking control', Icons.lightbulb_outline, () => _info(context, 'Suggestions', 'Intelligence recommends local songs with a reason and confidence score.')),
    ...
    _item(context, 'Exploration', 'Balance familiar choices with discovery', Icons.explore_outlined, () => _info(context, 'Exploration', 'Exploration stays local and confidence-aware as the recommendation graph matures.')),
    _item(context, 'Explanations', 'See why a recommendation was chosen', Icons.question_mark_rounded, () => _info(context, 'Explanations', 'Current predictions carry a human-readable reason and confidence instead of hiding the decision.')),
    ...
    _item(context, 'Session intelligence', 'Learn the direction of the current listening session', Icons.timeline_rounded, () => _info(context, 'Session intelligence', 'The session layer uses recent listening behavior to understand the direction of the current session.')),
    ...
    _item(context, 'Accent', 'Resonate violet accent', Icons.color_lens_outlined, () => _info(context, 'Accent', 'Resonate uses a violet accent with layered surfaces and theme-aware contrast.')),
    ...
    _item(context, 'Artwork style', 'Album-art presentation', Icons.album_outlined, () => _info(context, 'Artwork style', 'Artwork styling remains compatible with the existing player.')),
    _item(context, 'Animations', 'Motion and transition feel', Icons.animation_rounded, () => _info(context, 'Animations', 'Resonate keeps the polished player action animation and lightweight UI motion.')),
    _item(context, 'Compact/full controls', 'Choose how much playback UI is visible', Icons.view_agenda_outlined, () => _info(context, 'Compact/full controls', 'Control density remains part of the player presentation layer.')),
    _divider(),
    _header(context, 'Privacy', 'Your listening data stays yours', Icons.lock_outline_rounded),
    _item(context, 'Local-only learning', 'No cloud recommendation profile required', Icons.phone_android_rounded, () => _info(context, 'Local-only learning', 'Intelligence uses local listening events and on-device recommendation logic.')),
    ...
    _divider(),
    _header(context, 'About', 'Resonate • Aetherion', Icons.info_outline_rounded),
    _item(context, 'About & How to use', 'Guide, privacy notes and copyright', Icons.menu_book_outlined, () => Navigator.push(context, MaterialPageRoute(builder: (_) => const AboutScreen()))),
  ]));
