...
class SettingsScreen extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => Scaffold(
    ...
    body: Consumer<ThemeProvider>(builder: (context, themeProvider, _) => ListView(children: [
      ...
      ListTile(leading: const Icon(Icons.auto_awesome_outlined), title: const Text('Resonate Intelligence'), subtitle: const Text('What to expect from the recommendation engine'), trailing: const Icon(Icons.chevron_right), onTap: () => _showIntelligence(context)),
      const Divider(),
