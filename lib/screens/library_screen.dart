...
class _LibraryScreenState extends State<LibraryScreen> {
  ...
  Future<void> _playSong(BuildContext context, List<Song> songs, int index) async {
    ...
    if (success) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Unable to play this song. Check that the music file is still available.')));
    }
  }
                      ...
                      trailing: PopupMenuButton<String>(
                        onSelected: (value) async {
                          ...
                          if (value == 'queue') {
                            ...
                            if (mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Added to queue')));
                          }
