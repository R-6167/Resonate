...
class _PlayerScreenState extends State<PlayerScreen> {
  ...
  void initState() {
    ...
    FlutterVolumeController.addListener((volume) {
      _systemVolume.value = volume.clamp(0.0, 1.0).toDouble();
    }, emitOnStart: true);
  }
        ...
        child: Padding(
          ...
          child: ValueListenableBuilder<double>(
            ...
            builder: (_, value, __) => Row(children: [
              ...
              SizedBox(width: 48, child: Text('${(value * 100).round()}%', textAlign: TextAlign.end)),
            ]),
          ),
        ),
      ),
        ...
        children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Consumer<PlaybackFeaturesProvider>(builder: (_, playback, __) => Row(mainAxisSize: MainAxisSize.min, children: [
              ...
              if (playback.sleepTimerActive) Text(playback.sleepTimerLabel, style: Theme.of(context).textTheme.labelMedium?.copyWith(fontFeatures: const [FontFeature.tabularFigures()])),
            ])),
