      ...
      body: Consumer<IntelligenceProvider>(
        builder: (context, intelligence, _) => ListView(
          ...
          children: [
            ...
            RadioListTile<int>(value: 1, groupValue: intelligence.autonomy, onChanged: (v) => intelligence.setAutonomy(v!), title: const Text('Assist me'), subtitle: const Text('Keep the decision yours. Resonate highlights its strongest next-track prediction.'),),
            RadioListTile<int>(value: 2, groupValue: intelligence.autonomy, onChanged: (v) => intelligence.setAutonomy(v!), title: const Text('Autopilot'), subtitle: const Text('When confidence is high enough, Intelligence may choose the next track automatically. Your existing queue remains respected.'),),
            const Divider(),
            ...
            const ListTile(leading: Icon(Icons.explain_outlined), title: Text('Always explainable'), subtitle: Text('The player shows the evidence behind its strongest prediction instead of presenting an unexplained score.'),),
            const ListTile(leading: Icon(Icons.lock_outline_rounded), title: Text('Local-first'), subtitle: Text('This system is designed to learn from your library without requiring a cloud recommendation profile.'),),
