...
class _HomeDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final seen = <String>{};
    for (final song in library.favoriteSongs.followedBy(songs)) {
      if (seen.add(song.id)) recommendations.add(song);
      ...
      body: ListView(
        ...
        children: [
          ...
          if (music.currentSong != null) ...[
            ...
            Card(
              child: ListTile(
                leading: const Icon(Icons.play_circle_fill, size: 42),
                title: Text(music.currentSong!.title, maxLines: 1, overflow: TextOverflow.ellipsis),
                subtitle: Text(music.currentSong!.artist),
                trailing: IconButton(
          ...
          if (recommendations.isEmpty)
            Card(
              child: ListTile(
                ...
                title: const Text('Start building your library'),
                subtitle: const Text('Choose folders in Library Management, then scan them.'),
              ...
              (song) => Card(
                ...
                child: ListTile(
                  ...
                  onTap: () async {
                    ...
                    final success = await music.playSong(
                      song,
                      queue: songs,
                    ...
                    if (success) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Unable to play this song. Check that the file is still available.')),
                      );
                    }
                  },
                ),
